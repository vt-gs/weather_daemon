...
#
# ADDITIONAL COMMENT:
#   - This File is a copy and paste from pyweather github page
#   - copied 20171229 by Zach Leffke, KJ4QLP
#   - other than these additional commnets, unmodified.
#   - Utilized in VTGS weather Daemon for computing derived weather products.
